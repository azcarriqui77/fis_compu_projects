...
# Parámetros
# ========================================
file_in = "particles_positions_data.dat" # Nombre del fichero de datos
file_out = "particulas" # Nombre del fichero de salida (sin extensión)
...
interval = 0.9 # Tiempo entre fotogramas en milisegundos
