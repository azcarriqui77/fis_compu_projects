...
# Parámetros
# ========================================
file_in = "funciondeonda.dat" # Nombre del fichero de datos
file_out = "funciondeonda" # Nombre del fichero de salida (sin extensión)
...
line, = ax.plot(xs, frames_data[0][0], "-", color="blue", linewidth=1)
lines.append(line)

line, = ax.plot(xs, frames_data[0][1], "-", color="red", linewidth=1)
lines.append(line)

line, = ax.plot(xs, frames_data[0][2], "-", color="green", linewidth=1)
lines.append(line)
